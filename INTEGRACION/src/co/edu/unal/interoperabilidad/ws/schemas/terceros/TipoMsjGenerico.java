...
/**
 * TipoMsjGenerico bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class TipoMsjGenerico implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * tipoMsjGenerico Namespace URI =
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1826376806663425815L;
	/**
	 * field for InfoMensaje
	 */

	protected co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoInfoMensaje localInfoMensaje;

	/**
	 * Auto generated getter method
	 * 
	 * @return co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoInfoMensaje
	 */
	public co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoInfoMensaje getInfoMensaje() {
		return localInfoMensaje;
	}
	 ...
	 *            InfoMensaje
	 */
	public void setInfoMensaje(co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoInfoMensaje param) {

		this.localInfoMensaje = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":tipoMsjGenerico", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "tipoMsjGenerico", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TipoMsjGenerico parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			TipoMsjGenerico object = new TipoMsjGenerico();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"tipoMsjGenerico".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (TipoMsjGenerico) co.edu.unal.interoperabilidad.ws.gestionempleado.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
