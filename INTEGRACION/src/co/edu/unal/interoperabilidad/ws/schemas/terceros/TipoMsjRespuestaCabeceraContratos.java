/**
 * TipoMsjRespuestaCabeceraContratos.java
 *
...
/**
 * TipoMsjRespuestaCabeceraContratos bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class TipoMsjRespuestaCabeceraContratos extends co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenerico implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * tipoMsjRespuestaCabeceraContratos Namespace URI =
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7841304247785248355L;
	/**
	 * field for TipoMsjGenericoSequence This was an Array!
	 */

	protected co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequenceE[] localTipoMsjGenericoSequence;

	/**
	 * Auto generated getter method
	 * 
	 * @return co.edu.unal.interoperabilidad.ws.schemas.terceros.
	 *         TipoMsjGenericoSequenceE[]
	 */
	public co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequenceE[] getTipoMsjGenericoSequence() {
	 ...
	 */
	protected void validateTipoMsjGenericoSequence(co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequenceE[] param) {
	 ...
	 */
	public void setTipoMsjGenericoSequence(co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequenceE[] param) {
	 ...
	 *            TipoMsjGenericoSequenceE
	 */
	public void addTipoMsjGenericoSequence(co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequenceE param) {
		if (localTipoMsjGenericoSequence == null) {
			localTipoMsjGenericoSequence = new co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequenceE[] {};
		}

		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localTipoMsjGenericoSequence);
		list.add(param);
		this.localTipoMsjGenericoSequence = (co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequenceE[]) list
				.toArray(new co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequenceE[list.size()]);
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":tipoMsjRespuestaCabeceraContratos", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "tipoMsjRespuestaCabeceraContratos", xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
		...
		attribList.add(new javax.xml.namespace.QName("http://interoperabilidad.unal.edu.co/WS/Schemas/Terceros", "tipoMsjRespuestaCabeceraContratos"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TipoMsjRespuestaCabeceraContratos parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			TipoMsjRespuestaCabeceraContratos object = new TipoMsjRespuestaCabeceraContratos();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"tipoMsjRespuestaCabeceraContratos".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (TipoMsjRespuestaCabeceraContratos) co.edu.unal.interoperabilidad.ws.gestionempleado.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement()) {
					...
					list2.add(co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequenceE.Factory.parse(reader));
					...
					object.setTipoMsjGenericoSequence((co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequenceE[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
							co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequenceE.class, list2));
