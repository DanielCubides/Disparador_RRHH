...
/**
 * TipoDocente bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class TipoDocente extends co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoEmpleado implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * tipoDocente Namespace URI =
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2968073976845803610L;
	/**
	 * field for UBGAA
	 */

	protected co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoUBGAA localUBGAA;

	/**
	 * Auto generated getter method
	 * 
	 * @return co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoUBGAA
	 */
	public co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoUBGAA getUBGAA() {
		return localUBGAA;
	}
	 ...
	 *            UBGAA
	 */
	public void setUBGAA(co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoUBGAA param) {

		this.localUBGAA = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":tipoDocente", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "tipoDocente", xmlWriter);
		}
		...
		if (localUBGAA == null) {
			throw new org.apache.axis2.databinding.ADBException("UBGAA cannot be null!!");
		}
		localUBGAA.serialize(new javax.xml.namespace.QName("http://interoperabilidad.unal.edu.co/WS/Schemas/Terceros", "UBGAA"), xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
		...
		attribList.add(new javax.xml.namespace.QName("http://interoperabilidad.unal.edu.co/WS/Schemas/Terceros", "tipoDocente"));
		...
		elementList.add(new javax.xml.namespace.QName("http://interoperabilidad.unal.edu.co/WS/Schemas/Terceros", "UBGAA"));

		if (localUBGAA == null) {
			throw new org.apache.axis2.databinding.ADBException("UBGAA cannot be null!!");
		}
		elementList.add(localUBGAA);
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TipoDocente parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			TipoDocente object = new TipoDocente();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"tipoDocente".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (TipoDocente) co.edu.unal.interoperabilidad.ws.gestionempleado.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://interoperabilidad.unal.edu.co/WS/Schemas/Terceros", "UBGAA").equals(reader.getName())) {

					object.setUBGAA(co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoUBGAA.Factory.parse(reader));
