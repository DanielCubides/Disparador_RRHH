...
/**
 * TipoMsjDetalleContratos bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class TipoMsjDetalleContratos extends co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenerico implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * tipoMsjDetalleContratos Namespace URI =
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8645999332085320949L;
	/**
	 * field for TipoMsjGenericoSequence This was an Array!
	 */

	protected co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequence2[] localTipoMsjGenericoSequence;

	/**
	 * Auto generated getter method
	 * 
	 * @return co.edu.unal.interoperabilidad.ws.schemas.terceros.
	 *         TipoMsjGenericoSequence2[]
	 */
	public co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequence2[] getTipoMsjGenericoSequence() {
	 ...
	 */
	protected void validateTipoMsjGenericoSequence(co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequence2[] param) {
	 ...
	 */
	public void setTipoMsjGenericoSequence(co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequence2[] param) {
	 ...
	 *            TipoMsjGenericoSequence2
	 */
	public void addTipoMsjGenericoSequence(co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequence2 param) {
		if (localTipoMsjGenericoSequence == null) {
			localTipoMsjGenericoSequence = new co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequence2[] {};
		}

		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localTipoMsjGenericoSequence);
		list.add(param);
		this.localTipoMsjGenericoSequence = (co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequence2[]) list
				.toArray(new co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequence2[list.size()]);
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":tipoMsjDetalleContratos", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "tipoMsjDetalleContratos", xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
		...
		attribList.add(new javax.xml.namespace.QName("http://interoperabilidad.unal.edu.co/WS/Schemas/Terceros", "tipoMsjDetalleContratos"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TipoMsjDetalleContratos parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			TipoMsjDetalleContratos object = new TipoMsjDetalleContratos();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"tipoMsjDetalleContratos".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (TipoMsjDetalleContratos) co.edu.unal.interoperabilidad.ws.gestionempleado.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement()) {
					...
					list2.add(co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequence2.Factory.parse(reader));
					...
					object.setTipoMsjGenericoSequence((co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequence2[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
							co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoMsjGenericoSequence2.class, list2));
