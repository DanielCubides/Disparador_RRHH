...
/**
 * TipoTercero bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class TipoTercero implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * tipoTercero Namespace URI =
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8435307206756889771L;

	/**
	 * field for InfoBasicaTercero
	 */

	protected co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoInfoBasicaPersonal localInfoBasicaTercero;

	/**
	 * Auto generated getter method
	 * 
	 * @return 
	 *         co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoInfoBasicaPersonal
	 */
	public co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoInfoBasicaPersonal getInfoBasicaTercero() {
		return localInfoBasicaTercero;
	}
	 ...
	 *            InfoBasicaTercero
	 */
	public void setInfoBasicaTercero(co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoInfoBasicaPersonal param) {

		this.localInfoBasicaTercero = param;
	...
	protected co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoInfoContacto localInfoContacto;

	/**
	 * Auto generated getter method
	 * 
	 * @return 
	 *         co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoInfoContacto
	 */
	public co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoInfoContacto getInfoContacto() {
	 ...
	 *            InfoContacto
	 */
	public void setInfoContacto(co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoInfoContacto param) {
	...
	/**
	 * field for InfoTributaria
	 */

	protected co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoInfoTributariaTercero localInfoTributaria;
	 ...
	 */
	protected boolean localInfoTributariaTracker = false;

	public boolean isInfoTributariaSpecified() {
		return localInfoTributariaTracker;
	}
	 ...
	 *         TipoInfoTributariaTercero
	 */
	public co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoInfoTributariaTercero getInfoTributaria() {
		return localInfoTributaria;
	}
	 ...
	 *            InfoTributaria
	 */
	public void setInfoTributaria(co.edu.unal.interoperabilidad.ws.schemas.terceros.TipoInfoTributariaTercero param) {
		localInfoTributariaTracker = param != null;

		this.localInfoTributaria = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":tipoTercero", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "tipoTercero", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static TipoTercero parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			TipoTercero object = new TipoTercero();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"tipoTercero".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (TipoTercero) co.edu.unal.interoperabilidad.ws.gestionempleado.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
