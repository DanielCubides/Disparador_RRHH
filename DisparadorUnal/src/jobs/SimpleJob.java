		...
		public void execute(JobExecutionContext ctx) throws JobExecutionException {
			...
			try{
                ...
                for(EmpleadoDTO unEmpleadoVincula:listaEmpleadosVinculados){
                	System.out.println(unEmpleadoVincula.getTipoPeriodo());
                	try {
            			...
            			tipoNumeroDocumento.setTipoNumeroDocumento(unEmpleadoVincula.getContrato().toString());
                	...
                	System.out.println(unEmpleadoVincula.getContrato());
                }
